...
public:
	...
	inline void SetGrowthRate(int Index, double Value) {pGrowthRates[Index] = Value;}
	inline double GetGrowthRate(int Index) const {return pGrowthRates[Index];}
	inline void InitGrowthRateArray(int Size) {pGrowthRates = new double[Size];}
	inline bool GetUsingGrowthRate(void) {return usingGrowthRate;}
...
public:
	...
	inline void SetGrowthRate(int Index, double Value) {Structure.SetGrowthRate(Index,Value);} 
	inline double GetGrowthRate(int Index) const {return Structure.GetGrowthRate(Index);}
	inline void InitGrowthRateArray(int Size) {Structure.InitGrowthRateArray(Size);}
	inline bool GetUsingGrowthRate(void) {return Structure.GetUsingGrowthRate();}
